...
.bit-logo
{
 ...
 <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="dashboard.php"><b>
                         <img src="images/logo1.png" alt="home"/>
                 <!--  <img src="images/logo1.png" alt="home" class="hidden-sm hidden-xs" /> -->
                 <!--  <img src="images/bx-logo.png" alt="home" class="bit-logo hidden-lg hidden-md" /> -->
                </b>
                    ...
                    <!-- <li class="mega-dropdown">
                        ...
                        <ul class="dropdown-menu mega-dropdown-menu animated bounceInDown">
                            ...
                            <li class="col-sm-12 m-t-40 demo-box">
                                <div class="row">
                                    <div class="col-sm-2">
                                        <div class="white-box text-center bg-purple"><a href="index-2.html" target="_blank" class="text-white"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i><br/>Demo 1</a></div>
                                    </div>
                                    <div class="col-sm-2">
