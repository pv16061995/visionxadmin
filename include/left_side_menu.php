            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
              <div class="user-profile">
                  <div class="dropdown user-pro-body">
                      <a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php $explodeEmail=explode('@',$_SESSION['admin_email']); echo $explodeEmail[0];  ?> <span class="caret"></span></a>
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                  ...
                  <!--   <li class="nav-small-cap m-t-10">--- Main Menu</li> -->
                   <!-- <li> <a href="<?php echo BASE_PATH;?>dashboard" class="waves-effect active">
                        ...
                        </i> <span class="hide-menu"> Dashboard <span class="fa arrow"></span>
                        </a>
                         <ul class="nav nav-second-level">
                            <li> <a href="index-2.html">Minimalistic</a> </li>
                    ...
                    <li> <a href="<?php echo BASE_PATH;?>dashboard" class="waves-effect active">
                     ...
                     <li> <a href="<?php echo BASE_PATH;?>kycdetail" class="waves-effect active">
                        <i class="fa fa-list  fa-fw" data-icon="v">

                        </i> <span class="hide-menu"> Kyc Detail </span>
                        </a>
                   ...
                   <!--  <li> <a href="javascript:void(0);" class="waves-effect"><i class="linea-icon linea-basic fa-fw text-danger" data-icon="7"></i> <span class="hide-menu text-danger"> Multipurpose <span class="fa arrow"></span> <span class="label label-rouded label-danger pull-right">HOT</span></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li> <a href="http://eliteadmin.themedesigner.in/demos/eliteadmin-ecommerce/index.html">Ecommerce</a></li>
